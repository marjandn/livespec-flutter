...
import 'package:mock_api_generator/data/local_datasource/swagger_local_datasource.dart'
    as _i260;
import 'package:mock_api_generator/data/local_datasource/swagger_local_datasource_impl.dart'
    as _i224;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i260.SwaggerLocalDatasource>(
      () => _i224.SwaggerLocalDatasourceImpl(),
    );
    ...
    gh.lazySingleton<_i955.SwaggerRepository>(
      () => _i654.SwaggerRepositoryImpl(
        gh<_i1018.SwaggerRemoteDataSource>(),
        gh<_i260.SwaggerLocalDatasource>(),
      ),
    );
